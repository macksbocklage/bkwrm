  ...
  useEffect(() => {
    if (messages.length === 0 && bookTitle) {
      const welcomeMessage: Message = {
        id: 'welcome',
        role: 'assistant',
        content: `Hello! I'm here to help you discuss and understand "${bookTitle}". Ask me anything about the characters, plot, themes, or any other aspects of the book. I'll only provide information based on the book's content.`,
        timestamp: new Date()
      };
